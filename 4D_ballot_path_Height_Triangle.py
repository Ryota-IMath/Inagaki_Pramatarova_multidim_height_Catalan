...
def altern(t, bd):
    """Returns the number of 4d ballot paths from (0,0,0, 0) to t = (n,n,n, n) with intermediate points 
...
for i in range(6):
    s = ""
    for b in range(3, 3*i+1):
        s = s + " "+ str(altern((i, i, i, i), b)-altern((i, i, i, i), b-1)) + ","
    print(s)
